...
public final class ConstSecurity {
  ...
  public static final String REG_EX_REPLACE_BLANK = "\\s";
  public static final String REG_EX_REPLACE_PP = "-----\\w+ (PUBLIC|PRIVATE) KEY-----";
  ...
  public static final String PROP_CLAIM_DEFAULT_NAME = "client_id";
  public static final String PROP_CLAIM_DEFAULT_VALUE = "default-value";
